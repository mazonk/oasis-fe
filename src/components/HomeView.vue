...
onMounted(() => {
  ...
  // Gentle floating animation for the goal card
  gsap.to('.goal-card-inner', {
    y: -8,
    duration: 3,
    repeat: -1,
    yoyo: true,
  ...
  // Subtle pulse for the health score
  gsap.to('.health-circle', {
    scale: 1.03,
    duration: 4,
    repeat: -1,
    yoyo: true,
...
<template>
  <div class="space-y-8 max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <!-- Daily Goal Card -->
      <div class="goal-card">
        <div class="bg-indigo-600 rounded-[40px] p-8 text-white shadow-xl shadow-indigo-100 relative overflow-hidden group goal-card-inner h-full">
